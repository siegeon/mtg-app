...
interface ThreeZoneAppShellProps {
...
export const ThreeZoneAppShell: React.FC<ThreeZoneAppShellProps> = ({
...
const meta = {
  title: 'Prototypes/CollectionV2/ThreeZoneAppShell',
  component: ThreeZoneAppShell,
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
...
- Height reserved for row 3 even when empty
  ...
  tags: ['autodocs'],
} satisfies Meta<typeof ThreeZoneAppShell>;
