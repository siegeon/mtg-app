...
import { CollectionShell } from './CollectionShell.stories';
...
const Collection = ({ variant = 'empty' }: CollectionProps) => {
  ...
  const resultCount = filterChips.length === 0 ? { showing: 1203, total: 1203, unique: 847, value: '$2,847.50' } :
                     filterChips.length === 1 ? { showing: 847, total: 1203, unique: 623, value: '$1,891.25' } :
                     { showing: 247, total: 1203, unique: 247, value: '$892.75' };
...
const meta = {
  title: 'Prototypes/Collection/Collection',
